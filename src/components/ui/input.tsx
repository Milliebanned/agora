...
const fieldStyles =
  'w-full bg-elevate border border-border rounded-md px-3.5 py-3 text-[14px] text-foreground placeholder:text-subtle-foreground transition-colors focus:outline-none focus:border-accent/50 focus:bg-elevate disabled:opacity-40'
